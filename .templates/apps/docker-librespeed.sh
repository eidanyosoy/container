...
APPBRANCH="master"
APPLINK="https://api.github.com/repos/librespeed/speedtest"
NEWVERSION=$(curl -u $USERNAME:$TOKEN -sX GET "https://api.github.com/repos/librespeed/speedtest/releases/latest" | jq --raw-output '.tag_name')
...
BASEIMAGE="ghcr.io/linuxserver/baseimage-alpine-nginx:3.15"

INSTCOMMAND="apk add -U --update --no-cache"
PACKAGES="aria2 jq tar curl php7-ctype php7-gd php7-mysqli php7-pdo_pgsql php7-pdo_sqlite"
